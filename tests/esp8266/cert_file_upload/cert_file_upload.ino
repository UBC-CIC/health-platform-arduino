...
// hardcoded for now, will add custom wifi ap later **************
const char* AWS_endpoint = "a2sno6esl9wxbt-ats.iot.us-west-2.amazonaws.com"; //MQTT broker ip
...
//    Serial.println(msg);
//    client.publish("outTopic", sensor.getCO2PPM());
//    delay(5000);
